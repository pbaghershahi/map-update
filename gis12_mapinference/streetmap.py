...
class StreetMap:
    ...
    def load_osmdb(self, osmdb_filename):
        ...
        for id, tags, nodes in query_result:
            ...
            if ('highway' in list(way_tags_dict.keys())) and self._valid_highway_edge(way_tags_dict['highway']):
                ...
                for i in range(1, len(way_nodes_list)):
                    ...
                    if (True): #self._valid_node(in_node) or self._valid_node(out_node)):
                        ...
                        if ('oneway' not in list(way_tags_dict.keys())):
    ...
    def load_graphdb(self, grapdb_filename):
        ...
        for id, edge_ids in query_result:
            ...
            # print(f'{self.segments[id].head_edge.in_node, self.segments[id].tail_edge.out_node}: {self.segments[id]}')
